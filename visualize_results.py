...
def main(db_fname):
   ...
   ####kprint "total number of images : ", colorize(Color.RED, len(dsets), highlight=True)
    for k in dsets:
        rgb = db['data'][k][...]
       ...
       ####kprint "image name        : ", colorize(Color.RED, k, bold=True)
       ####kprint "  ** no. of chars : ", colorize(Color.YELLOW, charBB.shape[-1])
       ####kprint "  ** no. of words : ", colorize(Color.YELLOW, wordBB.shape[-1])
       ####kprint "  ** text         : ", colorize(Color.GREEN, txt)
